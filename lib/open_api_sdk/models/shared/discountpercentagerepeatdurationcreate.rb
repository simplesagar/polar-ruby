  ...
  module Models
    module Shared
      ...
      class DiscountPercentageRepeatDurationCreate
        ...
        def initialize(basis_points: nil, duration: nil, duration_in_months: nil, name: nil, type: nil, code: nil, ends_at: nil, max_redemptions: nil, metadata: nil, organization_id: nil, products: nil, starts_at: nil)
