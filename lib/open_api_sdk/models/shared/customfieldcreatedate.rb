  ...
  module Models
    module Shared
      ...
      class CustomFieldCreateDate
        ...
        sig { params(name: ::String, properties: Models::Shared::CustomFieldDateProperties, slug: ::String, type: ::String, metadata: T.nilable(T::Hash[Symbol, T.any(::String, ::Integer, ::Float, T::Boolean)]), organization_id: T.nilable(::String)).void }
