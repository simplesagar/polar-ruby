  ...
  module Models
    module Shared
      ...
      class CustomerStateSubscriptionMeter
        ...
        sig { params(amount: ::Integer, consumed_units: ::Float, created_at: ::DateTime, credited_units: ::Integer, id: ::String, meter_id: ::String, modified_at: ::DateTime).void }
        def initialize(amount: nil, consumed_units: nil, created_at: nil, credited_units: nil, id: nil, meter_id: nil, modified_at: nil)
          @amount = amount
