  ...
  module Models
    module Shared
      ...
      class CustomFieldCheckbox
        ...
        sig { params(created_at: ::DateTime, id: ::String, metadata: T::Hash[Symbol, T.any(::String, ::Integer, ::Float, T::Boolean)], modified_at: ::DateTime, name: ::String, organization_id: ::String, properties: Models::Shared::CustomFieldCheckboxProperties, slug: ::String, type: ::String).void }
