  ...
  module Models
    module Shared
      ...
      class BenefitGrant
        ...
        sig { params(benefit_id: ::String, created_at: ::DateTime, customer: Models::Shared::Customer, customer_id: ::String, id: ::String, is_granted: T::Boolean, is_revoked: T::Boolean, modified_at: ::DateTime, order_id: ::String, properties: T.any(Models::Shared::BenefitGrantDiscordProperties, Models::Shared::BenefitGrantGitHubRepositoryProperties, Models::Shared::BenefitGrantDownloadablesProperties, Models::Shared::BenefitGrantLicenseKeysProperties, Models::Shared::BenefitGrantCustomProperties), subscription_id: ::String, granted_at: T.nilable(::DateTime), revoked_at: T.nilable(::DateTime)).void }
        def initialize(benefit_id: nil, created_at: nil, customer: nil, customer_id: nil, id: nil, is_granted: nil, is_revoked: nil, modified_at: nil, order_id: nil, properties: nil, subscription_id: nil, granted_at: nil, revoked_at: nil)
