  ...
  module Models
    module Shared
      ...
      class EventCreateCustomer
        ...
        sig { params(customer_id: ::String, name: ::String, metadata: T.nilable(T::Hash[Symbol, T.any(::String, ::Integer, ::Float, T::Boolean)]), organization_id: T.nilable(::String), timestamp: T.nilable(::DateTime)).void }
        def initialize(customer_id: nil, name: nil, metadata: nil, organization_id: nil, timestamp: nil)
