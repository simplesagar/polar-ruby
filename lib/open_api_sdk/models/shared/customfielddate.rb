  ...
  module Models
    module Shared
      ...
      class CustomFieldDate
        ...
        field :properties, Models::Shared::CustomFieldDateProperties, { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('properties') } }
        ...
        sig { params(created_at: ::DateTime, id: ::String, metadata: T::Hash[Symbol, T.any(::String, ::Integer, ::Float, T::Boolean)], modified_at: ::DateTime, name: ::String, organization_id: ::String, properties: Models::Shared::CustomFieldDateProperties, slug: ::String, type: ::String).void }
