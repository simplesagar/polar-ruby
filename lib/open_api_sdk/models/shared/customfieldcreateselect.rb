  ...
  module Models
    module Shared
      ...
      class CustomFieldCreateSelect
        ...
        sig { params(name: ::String, properties: Models::Shared::CustomFieldSelectProperties, slug: ::String, type: ::String, metadata: T.nilable(T::Hash[Symbol, T.any(::String, ::Integer, ::Float, T::Boolean)]), organization_id: T.nilable(::String)).void }
