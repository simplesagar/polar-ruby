  ...
  module Models
    module Shared
      ...
      class CustomFieldSelect
        ...
        field :properties, Models::Shared::CustomFieldSelectProperties, { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('properties') } }
        ...
        sig { params(created_at: ::DateTime, id: ::String, metadata: T::Hash[Symbol, T.any(::String, ::Integer, ::Float, T::Boolean)], modified_at: ::DateTime, name: ::String, organization_id: ::String, properties: Models::Shared::CustomFieldSelectProperties, slug: ::String, type: ::String).void }
