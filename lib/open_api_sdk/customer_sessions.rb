...
module OpenApiSDK
  ...
  class CustomerSessions
    ...
    sig { params(request: T.any(Models::Shared::CustomerSessionCustomerIDCreate, Models::Shared::CustomerSessionCustomerExternalIDCreate), timeout_ms: T.nilable(Integer)).returns(Models::Operations::CustomerSessionsCreateResponse) }
    def create(request:, timeout_ms: nil)
      ...
      if Utils.match_status_code(http_response.status, ['201'])
        if Utils.match_content_type(content_type, 'application/json')
          ...
          obj = Crystalline.unmarshal_json(JSON.parse(http_response.env.response_body), Models::Shared::CustomerSession)
          response = Models::Operations::CustomerSessionsCreateResponse.new(
            status_code: http_response.status,
            content_type: content_type,
            raw_response: http_response,
            customer_session: obj
          )
